...
export default function InkPreview() {
  return (
    <div data-theme="ink" className="min-h-screen flex flex-col bg-[var(--color-background)] text-[var(--color-foreground)]">
      ...
      <main className="flex-1 relative overflow-hidden">
        ...
        <section className="relative z-10 flex flex-col items-center justify-center text-center px-4 py-24 sm:py-32 lg:py-40">
          ...
          <p className="text-lg md:text-xl mb-8 max-w-3xl text-white/80">
            This preview showcases our dark‑theme palette, gradients and interactive components.
          </p>
        ...
        <section className="relative z-10 container mx-auto grid gap-6 md:grid-cols-3 px-4 pb-24">
          <GlowCard>
            <h3 className="text-xl font-semibold mb-2 text-white">Guided Implants</h3>
            <p className="text-sm text-white/80">
              Precise implant placement with digital planning for optimal results.
            </p>
          </GlowCard>
          <GlowCard>
            <h3 className="text-xl font-semibold mb-2 text-white">Same-day Veneers</h3>
            <p className="text-sm text-white/80">
              3D printed veneers for a smile makeover delivered in a single visit.
            </p>
          </GlowCard>
          <GlowCard>
            <h3 className="text-xl font-semibold mb-2 text-white">Sedation Dentistry</h3>
            <p className="text-sm text-white/80">
      ...
      <footer className="bg-[var(--color-background)] border-t border-white/10 py-6 px-4">
        <div className="container mx-auto flex flex-col md:flex-row justify-between gap-4 items-center">
          <p className="text-sm text-white/80">&copy; {new Date().getFullYear()} St Mary's House Dental Care</p>
